...
const Footer = () => {
  return (
    <footer classNameName="  sw-full flex justify-around w-full bg-slate-800 text-white py-4 text-xs">
      <div className=" 2xl:justify-around 2xl:mr-0  xl:justify-between   xl:mx-4  2xl:px-4 xl:text-xl 2xl:text-4xl sm:ml-4 grid grid-cols-3  gap-6  sm:justify-between sm:gap-y-10 lg:grid-cols-4  md:flex md:justify-between max-w-screen-xl px-4 py-5 mx-auto text-sm text-gray-500 dark:text-gray-400 md:grid-cols-3 md:px-6">
        <ul
          className=" 2xl:justify-around xl:justify-between  xl:text-xl 2xl:text-4xl hidden mb-4 sm:flex sm:flex-col space-y-5 md:mb-0 md:block"
        ...
        >
          ...
          <li className=" xl:text-xl 2xl:text-4xl flex flex-row">
            <a
              href="#"
              className="xl:text-xl 2xl:text-4xl hover:underline space-y-4 text-xl flex flex-row space-x-4 hover:text-blue-600 dark:hover:text-blue-500"
          ...
          <li className=" xl:text-xl 2xl:text-4xl flex flex-row">
            ...
            <a
              href="#"
              className=" xl:text-xl 2xl:text-4xl hover:underline text-xl flex flex-row space-x-4 hover:text-blue-600 dark:hover:text-blue-500"
            ><img src="location.svg" className="h-12 w-12" alt="location"/>
        ...
        <ul className="xl:text-xl 2xl:text-4xl mb-4 space-y-4 md:mb-0">
            <h1 className="xl:text-4xl 2xl:text-6xl text-blue-500 px-4 py-4 font-bold text-4xl"> Services</h1>
          <li className="xl:text-xl 2xl:text-4xltext-xl">
            <a
              href="#"
              className="xl:text-xl 2xl:text-4xl hover:underline hover:text-blue-600 dark:hover:text-blue-500"
            >
        ...
        <ul className="mb-4 space-y-4  md:mb-0">
            <h1 className="xl:text-4xl 2xl:text-6xl text-blue-500 px-4 py-4 font-bold text-4xl">Expertise</h1>
          <li className="xl:text-xl 2xl:text-4xl text-xl">
            <a
              href="#"
              className="xl:text-xl 2xl:text-4xl hover:underline hover:text-blue-600 dark:hover:text-blue-500"
